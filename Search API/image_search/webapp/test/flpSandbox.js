		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Image search",
									"targetURL": "#dev401imagesearchimagesearch-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dev401imagesearchimagesearch-display": {
								"semanticObject": "dev401imagesearchimagesearch",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dev401imagesearch.imagesearch",
									"url": sap.ui.require.toUrl("dev401imagesearch/imagesearch")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Projeto 4",
									"targetURL": "#projeto4projeto4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projeto4projeto4-display": {
								"semanticObject": "projeto4projeto4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projeto4.projeto4",
									"url": sap.ui.require.toUrl("projeto4/projeto4")
								}
							}
						}
					}

sap.ui.define([
    ...
    "sap/m/MessageToast"
], function (BaseController, JSONModel, formatter, Filter, FilterOperator, BarcodeScanner, MessageToast) {
    "use strict";

    return BaseController.extend("productreport.controller.Worklist", {
        ...
        onProductScan: function () {
            let oResult = this.onCameraBascodeScan();

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Report",
									"targetURL": "#salesreportsales-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"salesreportsales-display": {
								"semanticObject": "salesreportsales",
								"action": "display",
								"description": "Sales report aplication.",
								"title": "Sales Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=salesreport.sales",
									"url": sap.ui.require.toUrl("salesreport/sales")
								}
							}
						}
					}
